          ...
          <div className="h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300">
            ...
            >
              <ul className="flex flex-col space-y-1">
                <li>
                  <a
                    className={`${clsName} ${route === "/" && "bg-gray-100"}`}
                    href="#"
                  >
                    <svg
                ...
                >
                  <button
                    type="button"
                    className={`hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 ${route.includes("api") && "bg-gray-200"}`}
                    aria-expanded="true"
                  ...
                  >
                    <ul className="ps-8 pt-1 space-y-1">
                      <li>
                        <Link
                          className={`${clsName} ${route === "/sedo-api" && "bg-gray-100"}`}
                          href="/sedo-api"
                        >
                          Sedo
                        </Link>
                      ...
                      <li>
                        <Link
                          className={`${clsName} ${route === "/godaddy-api" && "bg-gray-100"}`}
                          href="/godaddy-api"
                        >
                          Godaddy
                        </Link>
                      ...
                      <li>
                        <Link
                          className={`${clsName} ${route === "/namecheap-api" && "bg-gray-100"}`}
                          href="/namecheap-api"
                        >
                          NameCheap
                        </Link>
                      ...
                      <li>
                        <Link
                          className={`${clsName} ${route === "/namesilo-api" && "bg-gray-100"}`}
                          href="/namesilo-api"
                        >
                          Namesilo
                        </Link>
                      ...
                      <li>
                        <Link
                          className={`${clsName} ${route === "/dynadot-api" && "bg-gray-100"}`}
                          href="/dynadot-api"
                        >
                          Dynadot
                        </Link>
                      ...
                      <li>
                        <Link
                          className={`${clsName} ${route === "/open-ai-api" && "bg-gray-100"}`}
                          href="/open-ai-api"
                        >
                          Open Ai
                        </Link>
                      ...
                      <li>
                        <Link
                          className={`${clsName} ${route === "/google-api" && "bg-gray-100"}`}
                          href="/google-api"
                        >
                          Google Api
                        </Link>
