          ...
          <div className="w-full flex items-center justify-end ms-auto md:justify-between gap-x-1 md:gap-x-3">
            <div className="hidden md:block">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className="py-2 ps-10 pe-16 block w-full bg-white border-1 border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                  placeholder="Search"
                />
            ...
            <div className="flex flex-row items-center justify-end gap-1">
              ...
              >
                ...
                <span className="sr-only">Searchsdf</span>
              </button>
              <button
                type="button"
